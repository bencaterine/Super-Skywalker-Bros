...
ml /I%MASMINCPATH% /c  /coff  /Cp map.asm

if %errorlevel% neq 0 goto :error

link /SUBSYSTEM:WINDOWS  /LIBPATH:%MASMLIBPATH% game.obj blit.obj trig.obj lines.obj stars.obj bitmaps.obj map.obj libgame.obj
